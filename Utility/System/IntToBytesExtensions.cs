...
namespace System
{
    ...
    public static class IntToBytesExtensions
    {
        ...
        public static string ToFileSize(this int bytes, string unit = "B", int precision = DefaultPrecision,
            string zero = "n/a") =>
        ...
        /// <param name="zero">String to show if the value is 0</param>
        /// <returns>Filesize and quantifier formatted as a string.</returns>
        public static string ToFileSize(this long bytes, string unit = "B", int precision = DefaultPrecision,
            string zero = "n/a") =>
            ToFileSize((double) bytes, unit, precision, zero: zero);
        ...
        /// <param name="zero">String to show if the value is 0</param>
        /// <returns>Filesize and quantifier formatted as a string.</returns>
        public static string ToFileSize(this float bytes, string unit = "B", int precision = DefaultPrecision,
            string zero = "n/a") =>
            ToFileSize((double) bytes, unit, precision, zero: zero);
        ...
        /// <param name="zero">String to show if the value is 0</param>
        /// <returns>Filesize and quantifier formatted as a string.</returns>
        public static string ToFileSize(this double bytes, string unit = "B", int precision = DefaultPrecision,
            int kiloSize = 1024, string zero = "n/a")
        {
            ...
            return value.ToString(pow == 0 ? "F0" : "F" + precision) + " " + Units[(int) pow] + unit;
        }
    }
}