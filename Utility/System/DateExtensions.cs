namespace System
{
    public static class DateExtensions
    {
        ...
        private static string ToRelativeTimePast(DateTime dt, DateTime utcNow, bool includeTime = true)
        {
            ...
            if (delta < 60) return ts.Seconds == 1 ? "1 sec ago" : ts.Seconds + " secs ago";
            if (delta < 3600 /*60 mins * 60 sec*/) return ts.Minutes == 1 ? "1 min ago" : ts.Minutes + " mins ago";
        ...
        private static string ToRelativeTimeFuture(DateTime dt, DateTime utcNow, bool includeTime = true)
        {
            ...
            if (delta < 1) return "just now";
            if (delta < 60) return ts.Seconds == 1 ? "in 1 second" : "in " + ts.Seconds + " seconds";
            ...
            if (days <= 10) return "in " + days + " day" + (days > 1 ? "s" : "");
